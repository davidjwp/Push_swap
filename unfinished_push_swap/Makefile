...
SRCS		= $(PRINTF) $(wildcard utils/sort_100/*.c) $(wildcard utils/Instructions/*.c) $(wildcard utils/*.c) $(wildcard utils/Parsing/*.c) push_swap.h output_insts.c sort_3.c sort_5.c 
